...
//		restTemplate.getForEntity("localhost:8080/auth", ArrayList.class);
//		System.out.print(restTemplate);
		
		for (UserAuthData user : userRepo.findAll()) {
//			if (user.getUsername() == null || user.getPassword() == null) {
////	             Skip invalid users or throw an error with meaningful message
//				System.out.println("The DB is empty!");
//	            continue;
//	        }
//			System.out.println("Now data is here!");
...
//				.authenticationProvider(authenticationProvider())
			...
			.authorizeHttpRequests(registry -> {
				registry.requestMatchers("/signUp", "SignUp.html", "SignIn.html", "/BgImage.jpg", "/favicon.jpg", "/css/**", "/images/**", "/", "/user/get").permitAll();
